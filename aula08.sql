...
-- falha de ambiguidade, pois há duas colunas com o mesmo nome 
-- entre as tabelas
SELECT nome
...
-- OU
-- o unnion é utilizar para juntar duas ou mais consultas
...
-- o OUTER join é LEFT EXLCUDING JOIN + RIGHT EXLCUDING JOIN
SELECT p.nome nome_pokemon, t.nome tipo
FROM Pokemons p LEFT JOIN Tipos t ON t.tipoid = p.tipoid
WHERE T.tipoid is null
UNION
